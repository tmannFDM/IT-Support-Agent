/**
 * TicketCreateCard component for rendering ticket creation responses
 * Reference: specs/013-react-frontend-chat/plan.md (T016)
 */

import React from 'react';
import { TicketCreatePayload } from '../types/toolPayloads';

interface TicketCreateCardProps {
  ...
  return (
    <div className={`${priorityColor} border border-gray-300 rounded-lg p-4 max-w-md`}>
      <div className="flex justify-between items-start mb-3">
        <div>
          <div className="text-sm font-semibold text-gray-600">New Ticket Created</div>
      ...
      <div className="space-y-3">
        ...
        <div className="bg-blue-100 border border-blue-300 rounded px-3 py-2">
          <div className="text-sm text-blue-900">
            ✓ Ticket has been successfully created and assigned
          </div>
        </div>
      </div>
    </div>
