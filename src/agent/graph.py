...
from src.agent.nodes import check_ticket_status_node, classify_intent_node, generate_response_node
...
_graph.add_edge("classify_intent", "check_ticket_status")
_graph.add_edge("check_ticket_status", "generate_response")
